      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <div className="text-center mb-16 relative z-10">
            ...
            <p className="text-[10px] font-bold text-white/40 uppercase tracking-[0.4em] mb-12">Purchase Protection Protocol</p>
          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-6 mt-12">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                ...
                <h4 className="font-display font-bold text-green-500 text-lg">100% Safe</h4>
              </div>
            ...
            <motion.div 
              initial={{ opacity: 0, scale: 0.95 }}
              animate={{ opacity: 1, scale: 1 }}
              className="p-8 rounded-3xl bg-amber-500/5 border border-amber-500/20"
            >
              <div className="flex items-center gap-3 mb-4">
                <span className="text-2xl">⚠️</span>
                <h4 className="font-display font-bold text-amber-500 text-lg">95% Safe</h4>
              </div>
              <p className="text-white/60 text-sm leading-relaxed">
