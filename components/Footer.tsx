...
const Footer: React.FC<FooterProps> = ({ onOpenTerms, onOpenRefund, onOpenHelp, onOpenSupport }) => {
  return (
    <footer className="bg-[#0B0B0F] border-t border-white/5 pt-20 pb-10 relative z-10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
             <div className="flex items-center space-x-2 mb-6">
              <div className="w-12 h-8 bg-red-600 rounded-lg flex items-center justify-center font-display font-bold text-xs px-2 text-white shadow-lg">
                HGP
              </div>
          ...
          <div>
            <h4 className="font-bold mb-6 text-white uppercase tracking-widest text-sm">Support</h4>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://wa.me/8801878666388" target="_blank" className="w-10 h-10 bg-white/5 border border-white/10 rounded-full flex items-center justify-center hover:bg-green-600 hover:text-white transition-colors cursor-pointer text-slate-400">
              ...
              <a href="https://t.me/shuvomridha02" target="_blank" className="w-10 h-10 bg-white/5 border border-white/10 rounded-full flex items-center justify-center hover:bg-blue-400 hover:text-white transition-colors cursor-pointer text-slate-400">
